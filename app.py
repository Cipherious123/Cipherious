...
DATABASE = "postgresql://nishant:aVIjFtkaE986KvUpDmdG6PK06ro28Yul@dpg-ctseb652ng1s73c0fd5g-a.singapore-postgres.render.com/users_y783"
def send_cursor():   
    conn = psycopg2.connect( # Connect to your PostgreSQL database
        dbname="users_y783",
        user="nishant",
        password="aVIjFtkaE986KvUpDmdG6PK06ro28Yul",
        host="dpg-ctseb652ng1s73c0fd5g-a",
        port="5432"
    )
    cursor = conn.cursor()
    return cursor, conn
